...
sag_class_color = 
rownames(sag_class_color) = "Class"
...
heatmap.3(as.matrix(mat_ani_bin_filtered_col_ordered), 
          ...
          labRow = FALSE, 
          #ColSideColorsSize = 7, 
          RowSideColorsSize = nrow(sag_class_color), 
          KeyValueName="ANI"
...
legend("topright",legend=c("Class 1", "Class 2"),
       fill=c("#33cc33", "#006600"), border=FALSE, bty="n", y.intersp = 0.7, cex=0.7)
dev.off()
