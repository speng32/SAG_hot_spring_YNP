...
classification_file_filter12 = classification_file[which(classification_file[, 2] <= 1), ]
...
rowsidebar = t(data.frame(sag_class_spe_color))
rownames(rowsidebar) = "Species"
...
pdf("fig1_class1_only.pdf", width = 8, height = 10)
#par(cex.main=1)
...
legend("topright",legend=c("Acidocryptum nanophilium", "Acidilobus sp", "Vulcanisaeta sp", "Sulfolobus sp 2", "Sulfolobus sp 1", "Acidianus hospitalis", "Hydrogenobaculum sp", "Nanoarchaea", "Nanoarchaea & Acidocryptum nanophilium", "Nanoarchaea & Sulfolobus sp 1", "Nanoarchaea & Vulcanisaeta sp", "Nanoarchaea & Sulfolobus sp 2", "A. nanophilium & Sulfolobus sp 1"),
       fill=c("#a6cee3", "#1f78b4", "#b2df8a", "#33a02c", "#fb9a99", "#e31a1c", "#fdbf6f", "#ff7f00", "#cab2d6", "#6a3d9a", "#ffff99", "#b15928", "#cc00cc"), border=FALSE, bty="n", y.intersp = 0.7, cex=0.7)
dev.off()


pdf("heatmap_based_on_ani_with_class_spe_class1_only.pdf", width = 8, height = 10)
#par(cex.main=1)
...
pdf("bpc_heatmap_based_on_ani_order_class1_only.pdf", width = 8, height = 10)
