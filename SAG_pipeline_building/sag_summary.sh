...
# get sag summary file after adding viral info into the blast result

echo
echo Generating summary file of SAG blast hits
echo
...
if [ ! -d $BLASTRESADDFOLDER ]; then
	...
	python sag_s.py $PARTITIONMEMBER $BLASTRESADDFOLDER $OUTPUTFOLDER $OUTPUTFILE
